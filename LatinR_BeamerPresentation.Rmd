...
```{r,eval=FALSE, include=FALSE, echo=FALSE,out.width=290,fig.align='center', message=FALSE, warning=FALSE}
knitr::include_graphics(paste(file,"matrioska-si.gif",sep="/"))
```
