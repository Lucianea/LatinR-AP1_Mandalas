...
author: "Profa. Dra. Luciane, Prof. Dr. João Paulo, Prof. Dr. Orlando e Prof. Dr. Ariel"
...
- un método con elección del ángulo de rotación y 3 pasos de traslación fijos
...
# Explorando conceptos matemáticos - circunferência
...
# Explorando conceptos matemáticos - Astróide
```{r eval=FALSE, include=FALSE}
knitr::include_graphics("FigurasLatinR2023/astroid_circle.gif")
```
...
```{r,eval=FALSE,echo=FALSE,out.width=290,fig.align='center'}
knitr::include_graphics(paste(file,"homer-simpson-the-simpsons.gif",sep="/"))
```
...
```{r,eval=TRUE, include=FALSE, echo=FALSE,out.width=290,fig.align='center', message=FALSE, warning=FALSE}
...
```{r,echo=T,out.width=250,fig.align='center', message=FALSE, warning=FALSE}
require(MandalaR)
...
knitr::include_graphics("mandala_mao2.png")
...
* colors() => 657 posibilidades.
* resultados diferentes con pequeños cambios en los parámetros
* uso de secuencias o muestras de color aleatorias
